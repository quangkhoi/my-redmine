                ...
                ? new DailyReportSummary(
                    ...
                    [
                        new DailyReportGroup(
                            ...
                            99,
                            [
                                new DailyReportItem(201, "#201", "Fix mobile nav", "Done", "開発", null, "2026-07-03", "2026-07-08"),
                                new DailyReportItem(202, "#202", "Refine report layout", "In Progress", "開発", null, "2026-07-03", "2026-07-09")
                            ])
                    ],
